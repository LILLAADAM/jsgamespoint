...
import { contactInfo, contactSection } from "@data/index";
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-14 grid gap-10 lg:grid-cols-5">
              ...
              >
                ...
                <div>
                  ...
                  {"href" in item ? (
                    <a
                      href={item.href}
                      className="mt-0.5 block text-white transition-colors hover:text-blue-400"
                    >
                      {item.value}
                    </a>
                  ) : (
          ...
          <div className="lg:col-span-3">
            {submitted ? (
              <div className="flex h-full min-h-[320px] items-center justify-center rounded-2xl border border-blue-500/30 bg-blue-500/10 p-8 text-center">
