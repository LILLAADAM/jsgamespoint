...
export function HeadsetIcon({ className }: IconProps) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M19.114 5.636a9 9 0 010 12.728M16.463 8.288a5.25 5.25 0 010 7.424M6.75 8.25l4.72-4.72a.75.75 0 011.28.53v15.88a.75.75 0 01-1.28.53l-4.72-4.72H4.51c-.88 0-1.593-.714-1.593-1.593V9.843c0-.879.714-1.593 1.593-1.593h2.24z" />
    </svg>
  );
}
...
export function SocialIcon({ name, className }: { name: keyof typeof socialIconMap; className?: string }) {
...
export function ContactIcon({ name, className }: { name: keyof typeof contactIconMap; className?: string }) {
  const Icon = contactIconMap[name];
  return <Icon className={className} />;
}
